...
[![CI](https://github.com/mehmetkoksal-w/mind-palace/actions/workflows/ci.yml/badge.svg)](https://github.com/mehmetkoksal-w/mind-palace/actions/workflows/ci.yml)
[![Release](https://github.com/mehmetkoksal-w/mind-palace/actions/workflows/release.yml/badge.svg)](https://github.com/mehmetkoksal-w/mind-palace/actions/workflows/release.yml)
...
Full documentation is available at [mehmetkoksal-w.github.io/mind-palace](https://mehmetkoksal-w.github.io/mind-palace).
...
git clone https://github.com/mehmetkoksal-w/mind-palace.git
cd mind-palace
...
```sh
go install github.com/mehmetkoksal-w/mind-palace/apps/cli@latest
```
...
- **Windows**: Download `palace-windows-amd64.exe` from [releases](https://github.com/mehmetkoksal-w/mind-palace/releases).

### VS Code Extension

Download the `.vsix` file from [releases](https://github.com/mehmetkoksal-w/mind-palace/releases) and install:
...
```go
import (
    "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/memory"
    "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/corridor"
    "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/types"
)
