...
> **Breaking Changes**: This release includes command renames. See the [Migration Guide](https://mehmetkoksal-w.github.io/mind-palace/reference/migration) for upgrade instructions.
