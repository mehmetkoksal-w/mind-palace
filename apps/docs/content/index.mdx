...
| [LSP Server](/reference/lsp)              | Real-time editor diagnostics for patterns and contracts          |
| [VS Code Extension](/reference/extension) | HUD, sidebar, auto-sync, LSP integration                         |
