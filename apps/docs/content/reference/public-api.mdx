...
```sh
go get github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/memory
go get github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/corridor
go get github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/types
```
...
```go
import "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/types"
...
```go
import "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/memory"
...
```go
import "github.com/mehmetkoksal-w/mind-palace/apps/cli/pkg/corridor"
