...
```sh
go get github.com/The-PatientZero/mind-palace/apps/cli/pkg/memory
go get github.com/The-PatientZero/mind-palace/apps/cli/pkg/corridor
go get github.com/The-PatientZero/mind-palace/apps/cli/pkg/types
```
...
```go
import "github.com/The-PatientZero/mind-palace/apps/cli/pkg/types"
...
```go
import "github.com/The-PatientZero/mind-palace/apps/cli/pkg/memory"
...
```go
import "github.com/The-PatientZero/mind-palace/apps/cli/pkg/corridor"
