...
const banner = (
  <Banner storageKey="alpha-release">
    <a href="https://github.com/mehmetkoksal-w/mind-palace/releases" target="_blank">
...
const navbar = (
  <Navbar
    logo={<Logo />}
    projectLink="https://github.com/mehmetkoksal-w/mind-palace"
  />
)
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body>
        <Layout
          ...
          docsRepositoryBase="https://github.com/mehmetkoksal-w/mind-palace/tree/main/apps/docs/content"
          footer={footer}
