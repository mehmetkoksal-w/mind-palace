...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'contradictions',
        loadComponent: () => import('./features/contradictions/contradictions.component').then(m => m.ContradictionsComponent)
      },
      {
        path: 'postmortems',
        loadComponent: () => import('./features/postmortems/postmortems.component').then(m => m.PostmortemsComponent)
      },
      {
        path: 'decision-timeline',
        loadComponent: () => import('./features/decision-timeline/decision-timeline.component').then(m => m.DecisionTimelineComponent)
      },
      {
        path: 'context-preview',
        loadComponent: () => import('./features/context-preview/context-preview.component').then(m => m.ContextPreviewComponent)
      },
      {
        path: 'scope-explorer',
        loadComponent: () => import('./features/scope-explorer/scope-explorer.component').then(m => m.ScopeExplorerComponent)
      }
    ]
  },
