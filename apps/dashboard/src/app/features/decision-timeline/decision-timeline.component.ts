...
@Component({
  ...
  template: `
    <div class="decision-timeline-page">
      <div class="page-header">
        ...
        <p class="subtitle">Track the evolution of architectural decisions over time</p>
      </div>
      ...
      @if (!loading() && decisions().length > 0) {
        ...
        <!-- Legend -->
        <div class="legend">
          <span class="legend-item"><span class="dot dot-green"></span> Success</span>
          <span class="legend-item"><span class="dot dot-red"></span> Failed</span>
          <span class="legend-item"><span class="dot dot-yellow"></span> Mixed</span>
          <span class="legend-item"><span class="dot dot-gray"></span> Unknown</span>
        </div>
          ...
          @for (decision of decisions(); track decision.id) {
            ...
            >
              <div class="card-header">
                <span class="outcome-dot" [class]="'dot-' + decision.outcomeColor"></span>
              ...
              <button class="btn-chain" (click)="loadChain(decision.id); $event.stopPropagation()">
                View Chain
              </button>
            </div>
          }
                  ...
                  @for (pred of chain()!.predecessors; track pred.decision.id) {
                    <div class="chain-item predecessor">
                      ...
                      <div class="chain-decision">
                        ...
                        <span class="chain-date">{{ formatDate(pred.decision.createdAt) }}</span>
                      </div>
                    </div>
                  }
              ...
              <div class="chain-current">
                ...
                <div class="current-decision">
                  ...
                  @if (chain()!.current.rationale) {
                    <div class="current-rationale">{{ chain()!.current.rationale }}</div>
                  }
                </div>
              </div>
                  ...
                  @for (succ of chain()!.successors; track succ.decision.id) {
                    <div class="chain-item successor">
                      ...
                      <div class="chain-decision">
                        ...
                        <span class="chain-date">{{ formatDate(succ.decision.createdAt) }}</span>
                      </div>
                    </div>
                  }
                </div>
  ...
  styles: [`
    ...
    .decision-card.outcome-green { border-left: 4px solid #22c55e; }
    .decision-card.outcome-red { border-left: 4px solid #ef4444; }
    .decision-card.outcome-yellow { border-left: 4px solid #f59e0b; }
    .decision-card.outcome-gray { border-left: 4px solid #64748b; }
