          ...
          <div class="list">
            ...
            >
              <div class="item-header">
                <span
                  class="severity-dot"
                  [class]="'dot-' + pm.severity"
                ></span>
                <span class="status-badge" [class]="'badge-' + pm.status">{{
                  pm.status
                }}</span>
              </div>
        ...
        <div class="detail-panel">
          ...
          <div class="detail-content">
            <div class="detail-header">
              ...
              <div class="header-badges">
                <span
                  ...
                  [class]="'severity-' + selectedPostmortem()!.severity"
                >
                  {{ selectedPostmortem()!.severity | uppercase }}
                </span>
                <span
                  class="status-badge"
                  [class]="'badge-' + selectedPostmortem()!.status"
                >
            ...
            <div class="detail-meta">
              <span
                >Created:
                {{ formatDate(selectedPostmortem()!.createdAt) }}</span
              >
              @if (selectedPostmortem()!.resolvedAt) {
              <span
                >Resolved:
                {{ formatDate(selectedPostmortem()!.resolvedAt) }}</span
              >
              }
            </div>
            ...
            <div class="detail-section">
              ...
              <ul class="lessons-list">
                @for (lesson of selectedPostmortem()!.lessonsLearned; track
                lesson) {
                <li>{{ lesson }}</li>
                }
              </ul>
            ...
            <div class="detail-section">
              ...
              <span class="relation-link">{{
                selectedPostmortem()!.relatedDecision
              }}</span>
            </div>
            }
...
export class PostmortemsComponent implements OnInit {
  ...
  loadPostmortems() {
    ...
    this.api
      .getPostmortems(this.statusFilter, this.severityFilter, 100)
      .subscribe({
        next: (res) => {
          ...
          if (this.selectedId() && res.postmortems) {
            const found = res.postmortems.find(
