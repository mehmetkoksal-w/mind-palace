...
@Component({
    ...
    <div class="ideas-page">
      <div class="page-header">
        <h2>Ideas</h2>
        <p class="subtitle">Track exploration and concepts across your codebase</p>
      </div>
          ...
          @for (idea of ideas(); track idea.id) {
            <div class="idea-card" [class]="'status-' + idea.status">
              <div class="idea-header">
                ...
                <span class="scope" [title]="idea.scopePath">{{ idea.scope || 'Global' }}</span>
              </div>
  ...
  `,
    ...
    .idea-card.status-active { border-left: 3px solid #22c55e; }
    .idea-card.status-exploring { border-left: 3px solid #3b82f6; }
    .idea-card.status-implemented { border-left: 3px solid #9d4edd; }
    .idea-card.status-dropped { border-left: 3px solid #64748b; }
