    ...
    <div class="conversations-container">
      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <p class="subtitle">Review past AI conversations and extracted knowledge</p>
        </div>
          ...
          <div class="conversation-detail">
            <div class="detail-header">
              ...
              <div class="detail-title">
                ...
                <div class="detail-meta">
                  <span class="agent-badge" [attr.data-agent]="selectedConversation()!.agentType">
            ...
            @if (viewMode() === 'chat') {
              <div class="chat-view">
                ...
                @if (selectedConversation()!.extracted && selectedConversation()!.extracted!.length > 0) {
                  <div class="extracted-sidebar">
                    <h3>Extracted Knowledge</h3>
                    @for (record of selectedConversation()!.extracted; track record.id) {
                        ...
                        <div class="event-content">
                          <div class="event-header">
                            @if (event.type === 'message') {
                              ...
                              <span class="event-kind" [attr.data-kind]="event.recordKind">
