...
LDFLAGS="-s -w -X github.com/mehmetkoksal-w/mind-palace/apps/cli/internal/cli.buildVersion=$VERSION -X github.com/mehmetkoksal-w/mind-palace/apps/cli/internal/cli.buildCommit=$COMMIT -X github.com/mehmetkoksal-w/mind-palace/apps/cli/internal/cli.buildDate=$DATE"
