...
Download `.vsix` from [GitHub Releases](https://github.com/koksalmehmet/mind-palace/releases):
...
See [CHANGELOG.md](https://github.com/koksalmehmet/mind-palace/blob/main/CHANGELOG.md) for full release history.
