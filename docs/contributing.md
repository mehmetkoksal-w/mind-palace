...
Found a bug? Please [open an issue](https://github.com/koksalmehmet/mind-palace/issues/new) with:
...
Have an idea? [Open an issue](https://github.com/koksalmehmet/mind-palace/issues/new) describing:
...
- Follow the [Code of Conduct](https://github.com/koksalmehmet/mind-palace/blob/main/CODE_OF_CONDUCT.md)

## Questions?

- Open a [discussion](https://github.com/koksalmehmet/mind-palace/discussions)
- Check existing [issues](https://github.com/koksalmehmet/mind-palace/issues)
- Read the [documentation](https://koksalmehmet.github.io/mind-palace)
