...
```sh
go get github.com/koksalmehmet/mind-palace/pkg/memory
go get github.com/koksalmehmet/mind-palace/pkg/corridor
go get github.com/koksalmehmet/mind-palace/pkg/types
```
...
```go
import "github.com/koksalmehmet/mind-palace/pkg/types"
...
```go
import "github.com/koksalmehmet/mind-palace/pkg/memory"
...
```go
import "github.com/koksalmehmet/mind-palace/pkg/corridor"
